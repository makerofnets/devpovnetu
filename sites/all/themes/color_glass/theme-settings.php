...
function color_glass_form_system_theme_settings_alter(&$form, $form_state) {
  ...
  $form['general']['container']['bootstrap_fluid_container'] = array(
    ...
    '#default_value' => _bootstrap_setting('fluid_container', $theme),
  ...
  $form['general']['buttons']['bootstrap_button_size'] = array(
    ...
    '#default_value' => _bootstrap_setting('button_size', $theme),
  ...
  $form['general']['buttons']['bootstrap_button_colorize'] = array(
    ...
    '#default_value' => _bootstrap_setting('button_colorize', $theme),
  ...
  $form['general']['buttons']['bootstrap_button_iconize'] = array(
    ...
    '#default_value' => _bootstrap_setting('button_iconize', $theme),
  ...
  $form['general']['forms']['bootstrap_forms_required_has_error'] = array(
    ...
    '#default_value' => _bootstrap_setting('forms_required_has_error', $theme),
  ...
  $form['general']['forms']['bootstrap_forms_smart_descriptions'] = array(
    ...
    '#default_value' => _bootstrap_setting('forms_smart_descriptions', $theme),
  );
  $form['general']['forms']['bootstrap_forms_smart_descriptions_limit'] = array(
    ...
    '#default_value' => _bootstrap_setting('forms_smart_descriptions_limit', $theme),
    '#states' => array(
      'visible' => array(
  ...
  $form['general']['forms']['bootstrap_forms_smart_descriptions_allowed_tags'] = array(
    ...
    '#default_value' => _bootstrap_setting('forms_smart_descriptions_allowed_tags', $theme),
    '#states' => array(
      'visible' => array(
        ':input[name="bootstrap_forms_smart_descriptions"]' => array('checked' => TRUE),
      ),
  ...
  $form['general']['images']['bootstrap_image_shape'] = array(
    ...
    '#default_value' => _bootstrap_setting('image_shape', $theme),
    '#empty_option' => t('None'),
    '#options' => array(
  ...
  $form['general']['images']['bootstrap_image_responsive'] = array(
    ...
    '#default_value' => _bootstrap_setting('image_responsive', $theme),
  ...
  $form['general']['tables']['bootstrap_table_bordered'] = array(
    ...
    '#default_value' => _bootstrap_setting('table_bordered', $theme),
  ...
  $form['general']['tables']['bootstrap_table_responsive'] = array(
    ...
    '#default_value' => _bootstrap_setting('table_responsive', $theme),
  ...
  $form['components']['breadcrumbs']['bootstrap_breadcrumb'] = array(
    ...
    '#default_value' => _bootstrap_setting('breadcrumb', $theme),
    '#options' => array(
      0 => t('Hidden'),
      1 => t('Visible'),
  ...
  $form['components']['breadcrumbs']['bootstrap_breadcrumb_home'] = array(
    ...
    '#default_value' => _bootstrap_setting('breadcrumb_home', $theme),
  ...
  $form['components']['breadcrumbs']['bootstrap_breadcrumb_title'] = array(
    ...
    '#default_value' => _bootstrap_setting('breadcrumb_title', $theme),
  ...
  $form['components']['navbar']['bootstrap_navbar_position'] = array(
    ...
    '#default_value' => _bootstrap_setting('navbar_position', $theme),
    '#options' => array(
  ...
  $form['components']['navbar']['bootstrap_navbar_inverse'] = array(
    ...
    '#default_value' => _bootstrap_setting('navbar_inverse', $theme),
  );
  ...
  foreach ($regions as $name => $title) {
    $form['components']['region_wells']['bootstrap_region_well-' . $name] = array(
      ...
      '#options' => $wells,
      '#default_value' => _bootstrap_setting('region_well-' . $name, $theme),
    );
  }
  ...
  $form['javascript']['anchors']['bootstrap_anchors_fix'] = array(
    ...
    '#default_value' => _bootstrap_setting('anchors_fix', $theme),
  ...
  $form['javascript']['anchors']['bootstrap_anchors_smooth_scrolling'] = array(
    ...
    '#default_value' => _bootstrap_setting('anchors_smooth_scrolling', $theme),
  ...
  $form['javascript']['forms']['bootstrap_forms_has_error_value_toggle'] = array(
    ...
    '#default_value' => _bootstrap_setting('forms_has_error_value_toggle', $theme),
  ...
  $form['javascript']['popovers']['options']['bootstrap_popover_animation'] = array(
    ...
    '#default_value' => _bootstrap_setting('popover_animation', $theme),
  );
  $form['javascript']['popovers']['options']['bootstrap_popover_html'] = array(
    ...
    '#default_value' => _bootstrap_setting('popover_html', $theme),
  );
  $form['javascript']['popovers']['options']['bootstrap_popover_placement'] = array(
    ...
    '#default_value' => _bootstrap_setting('popover_placement', $theme),
  ...
  $form['javascript']['popovers']['options']['bootstrap_popover_selector'] = array(
    ...
    '#default_value' => _bootstrap_setting('popover_selector', $theme),
  );
  $form['javascript']['popovers']['options']['bootstrap_popover_trigger'] = array(
    '#type' => 'checkboxes',
    '#title' => t('trigger'),
    '#description' => t('How a popover is triggered.'),
    '#default_value' => _bootstrap_setting('popover_trigger', $theme),
    '#options' => drupal_map_assoc(array(
      'click',
      'hover',
      'focus',
  ...
  $form['javascript']['popovers']['options']['bootstrap_popover_trigger_autoclose'] = array(
    ...
    '#default_value' => _bootstrap_setting('popover_trigger_autoclose', $theme),
  );
  $form['javascript']['popovers']['options']['bootstrap_popover_title'] = array(
    ...
    '#default_value' => _bootstrap_setting('popover_title', $theme),
  );
  $form['javascript']['popovers']['options']['bootstrap_popover_content'] = array(
    ...
    '#default_value' => _bootstrap_setting('popover_content', $theme),
  );
  $form['javascript']['popovers']['options']['bootstrap_popover_delay'] = array(
    ...
    '#default_value' => _bootstrap_setting('popover_delay', $theme),
  );
  ...
  $form['javascript']['tooltips']['bootstrap_tooltip_enabled'] = array(
    ...
    '#default_value' => _bootstrap_setting('tooltip_enabled', $theme),
  );
  ...
  $form['javascript']['tooltips']['options']['bootstrap_tooltip_animation'] = array(
    ...
    '#default_value' => _bootstrap_setting('tooltip_animation', $theme),
  );
  $form['javascript']['tooltips']['options']['bootstrap_tooltip_html'] = array(
    ...
    '#default_value' => _bootstrap_setting('tooltip_html', $theme),
  );
  $form['javascript']['tooltips']['options']['bootstrap_tooltip_placement'] = array(
    ...
    '#default_value' => _bootstrap_setting('tooltip_placement', $theme),
    '#options' => drupal_map_assoc(array(
      'top',
      'bottom',
      'left',
  ...
  $form['javascript']['tooltips']['options']['bootstrap_tooltip_selector'] = array(
    ...
    '#default_value' => _bootstrap_setting('tooltip_selector', $theme),
  );
  $form['javascript']['tooltips']['options']['bootstrap_tooltip_trigger'] = array(
    '#type' => 'checkboxes',
    '#title' => t('trigger'),
    '#description' => t('How a tooltip is triggered.'),
    '#default_value' => _bootstrap_setting('tooltip_trigger', $theme),
    '#options' => drupal_map_assoc(array(
      'click',
      'hover',
      'focus',
  ...
  $form['javascript']['tooltips']['options']['bootstrap_tooltip_delay'] = array(
    ...
    '#default_value' => _bootstrap_setting('tooltip_delay', $theme),
  );
  $form['javascript']['tooltips']['options']['bootstrap_tooltip_container'] = array(
    ...
    '#default_value' => _bootstrap_setting('tooltip_container', $theme),
  );
  ...
  $form['cdn']['bootstrap_bscdn_css'] = array(
    '#type' => 'textfield',
    ...
    '#default_value' => _bootstrap_setting('bscdn_css', $theme),
  );
  // Bootstrap JS CDN URL.
  $form['cdn']['bootstrap_bscdn_js'] = array(
    '#type' => 'textfield',
    ...
    '#default_value' => _bootstrap_setting('bscdn_js', $theme),
  );
  // Font awesome link.
  $form['cdn']['bootstrap_fontawesome'] = array(
    '#type' => 'textfield',
    ...
    '#default_value' => _bootstrap_setting('fontawesome', $theme),
  );
  // Google Fonts link.
  $form['cdn']['bootstrap_googlefont'] = array(
    '#type' => 'textfield',
    ...
    '#default_value' => _bootstrap_setting('googlefont', $theme),
  );
  // Advanced settings.
  $form['advanced'] = array(
    '#type' => 'fieldset',
  ...
  $form['advanced']['bootstrap_toggle_jquery_error'] = array(
    ...
    '#default_value' => _bootstrap_setting('toggle_jquery_error', $theme),
  ...
  $form['advanced']['bootstrap_search_box'] = array(
    '#type' => 'checkbox',
    '#title' => t('Show Searchbox'),
    '#default_value' => _bootstrap_setting('search_box', $theme),
    '#description' => t('Show search box in navigation.'),
  );
  $form['advanced']['bootstrap_flatit'] = array(
    '#type' => 'checkbox',
    '#title' => t('Flat it'),
    '#default_value' => _bootstrap_setting('flatit', $theme),
    '#description' => t('Overrides all the border radius to zero.'),
  );
  $form['advanced']['bootstrap_credits'] = array(
    '#type' => 'checkbox',
    '#title' => t('Display credits'),
    '#default_value' => _bootstrap_setting('credits', $theme),
  ...
  $form['contents'] = array(
    '#type' => 'fieldset',
    '#title' => t('Homepage Content settings'),
    '#group' => 'bootstrap',
    '#description' => t('This portion helps you to setup some default contents without using drupal block system for frontpage, but still you can use blocks to override this'),
  );
  $form['contents']['home_welcome'] = array(
    '#title' => t('Content for Home page Welcome block'),
    '#description' => t('Content for Home page Welcome block. Use &lt;disable&gt; to disable this region.'),
    '#default_value' => _bootstrap_helper_theme_get_setting('home_welcome') ,
    '#type' => 'textarea',
    '#required' => FALSE,
  );
  $form['contents']['home_cta'] = array(
    '#title' => t('Content for Home page CTA'),
    '#description' => t('Content for Home page Call to action block. Use &lt;disable&gt; to disable this region.'),
    '#default_value' => _bootstrap_helper_theme_get_setting('home_cta') ,
    '#type' => 'textarea',
    '#required' => FALSE,
  );
  $form['contents']['home_features'] = array(
    '#title' => t('Content for Home page Features Area'),
    '#description' => t('Content for Home page Features Area. Use &lt;disable&gt; to disable this region.'),
    '#default_value' => _bootstrap_helper_theme_get_setting('home_features') ,
    '#type' => 'textarea',
    '#required' => FALSE,
  );
  $form['contents']['home_bottom'] = array(
    '#title' => t('Content for Home page Bottom Content'),
    '#description' => t('Content for Home page Bottom Content. Use &lt;disable&gt; to disable this region.'),
    '#default_value' => _bootstrap_helper_theme_get_setting('home_bottom') ,
    '#type' => 'textarea',
    '#required' => FALSE,
  );
  $form['contents']['footer_copyright'] = array(
    '#title' => t('Content for Home page footer_copyright'),
    '#description' => t('Content for Home page footer_copyright. Use &lt;disable&gt; to disable this region.'),
    '#default_value' => _bootstrap_helper_theme_get_setting('footer_copyright') ,
    '#type' => 'textarea',
    '#required' => FALSE,
  );
    $form['contents']['footer_logos'] = array(
    '#title' => t('Content for Home page footer_logos'),
    '#description' => t('Content for Home page footer_logos. Use &lt;disable&gt; to disable this region.'),
    '#default_value' => _bootstrap_helper_theme_get_setting('footer_logos') ,
    '#type' => 'textarea',
    '#required' => FALSE,
  );
  $form['contents']['footer_message'] = array(
    '#title' => t('Content for Home page footer_message'),
    '#description' => t('Content for Home page footer_message. Use &lt;disable&gt; to disable this region.'),
    '#default_value' => _bootstrap_helper_theme_get_setting('footer_message') ,
    '#type' => 'textarea',
    '#required' => FALSE,
  );
