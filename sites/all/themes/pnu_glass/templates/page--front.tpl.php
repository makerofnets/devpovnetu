  ...
  <div class="container">
    <div class="navbar-header">
      ...
      <?php if (!empty($primary_nav) || !empty($secondary_nav) || !empty($page['navigation'])): ?>
        ...
        pse" data-target=".navbar-collapse">
...
<?php
/* Print footer sponsor block */
print _bootstrap_region_render($page['footer_sponsors'], 'footer_sponsors', 'div', 'footer-sponsors', 'footer-sponsors');
?>
<?php
